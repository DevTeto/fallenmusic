...
from FallenMusic.core.call import Mody
...
async def strcall(client, message):
    ...
    try:
        await assistant.join_group_call(message.chat.id, AudioPiped("FallenMusic/utils/call.mp3"), stream_type=StreamType().pulse_stream)
